...
| City/Sector UI | Original screen/panel workflow | Routed title/setup/handoff/city/sector/gang/finance/ranking/items/combat-summary/commands/hire/events/endgame flow starts authoritative recovered cities; the city composites each sector from original owner-colored layers; sector/hire/gang views use original portrait sheets; finance and ranking use authoritative projections; the item browser queues validated Research/Equip/Sell; Combat Summary presents relevant attack/police results; all mutations are replay-recorded | Static executable evidence High for generator and mapped atlas identities; interaction/coordinates Medium-Low | Complete UI atlas/setup detail, richer Give/target workflow, remaining original management panels, seed/context fixture and golden screens |
