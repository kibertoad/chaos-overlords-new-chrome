...
| City/Sector UI | Original screen/panel workflow | Title/setup/handoff/city/events/endgame router starts authoritative recovered cities; scenario, duration and local-player setup plus keyboard/mouse board/phase actions and replay-recorded notification dismissal are implemented provisionally | Static executable evidence High for generator; prototype layout/interaction Low | Complete UI atlas/setup detail, remaining original panels, seed/context fixture and golden screens |
