...
| City/Sector UI | Original screen/panel workflow | Routed title/setup/handoff/city/sector/gang/commands/hire/events/endgame flow starts authoritative recovered cities; sector/gang panels expose sites, influence, effective stats, equipment and queued commands; Core-approved commands, Hire and notification mutations are replay-recorded | Static executable evidence High for generator; prototype layout/interaction Low | Complete UI atlas/setup detail, richer target workflow, remaining finance/research/ranking panels, seed/context fixture and golden screens |
