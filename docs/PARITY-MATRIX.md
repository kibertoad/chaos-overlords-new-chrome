...
| City/Sector UI | Original screen/panel workflow | Title/setup/city router starts authoritative recovered cities; scenario, duration and local-player setup plus keyboard/mouse board/phase actions are implemented provisionally | Static executable evidence High for generator; prototype layout/interaction Low | UI atlas, full setup detail, original panels, seed/context fixture and golden screens |
