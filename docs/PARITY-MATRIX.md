...
| Comlink | View/send messages among human Overlords; newest 16 received messages retained | Not implemented | Manual workflow and static 166-byte queue/count/copy/cursor paths High; exact record fields Medium | Implement local-human composition, multi-recipient delivery, unread state, bounded viewing, persistence, hashing, and replay |
