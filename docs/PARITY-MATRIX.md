...
| AI | Objective/difficulty-aware computer players | Deterministic objective-aware planner with recovered reaction/attitude initialization and updates, all nine difficulty-band consumers, role/family assignment, action history, hiring and placement, complete family-13/14 handlers, family-1 continuations, complete family-11 equipment/Heal/local-Attack/formation sequence, and family-3 cash-site Heal/Equip/Influence/Control/mode-8 Move continuations. Six-by-81 formation sectors preserve inactive family records and are hashed/saved/replayed. Unrecovered handlers use the explicit provisional fallback planner. | Strategic-state, family-3/11/13/14, persistence, and resolution-band integration High; complete original planning policy Low | Complete family 3's opponent/terminal branches; add fixed original-runtime family traces and larger-player stress cases; recover remaining handlers |
...
Family 3 now uses exact cash-site decisions after previous None, Control,
Equip, Heal, Influence, and Snitch actions. Its recovered paths include the
...
mode-8 movement using summed unfinished positive Cash. The previous
Attack/Hide/Move branch and late family/Terminate overrides are still
provisional and are not included in the parity claim.
