...
| Police | Combat 20, Detect 12, stealth detection curve; 3–5-turn presence extended by another Crackdown; third occurrence within five turns neutralizes control; Control prohibited while present | Deterministic duration/extension and two-entry occurrence history with v4 save migration, control/influence cleanup, and visible countdown; provisional phase-wide attacks, detection, damage, events, notifications, casualties, and submission/runtime Control lockout implemented | Manual/save layout High for constants/curve/duration/history/lockout; duration RNG, defense formula, notification and ordering Low | Binary fixtures for timing, RNG consumption, duration draw/extension and three-in-five boundary/notification |
