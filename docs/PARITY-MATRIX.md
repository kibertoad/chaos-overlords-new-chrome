...
| Timers | Scenario limits of 26/52/104/208 turns; optional human planning limits of None/30 seconds/2 minutes/5 minutes | Scenario limits are authoritative model state. The recovered enabled-per-match planning countdown uses its original setup hit regions and 60-pixel main-panel bar, runs through planning panels, emits slots 7/8 in the last 10/final second, and submits the normal replay-recorded finish-planning operation on expiry without showing the idle-gang confirmation. | Help and static executable mapping/expiry/bar/sound boundaries High; warning replay cadence Medium | Controlled original warning-cadence capture and end-turn boundary fixtures |
