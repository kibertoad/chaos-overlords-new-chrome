...
| Police | Combat 20, Detect 12, stealth detection curve; 3–5-turn presence extended by another Crackdown; Control prohibited while present | Deterministic duration/extension with v3 save migration and visible countdown; provisional phase-wide attacks, detection, damage, events, notifications, casualties, and submission/runtime Control lockout implemented | Manual, High for constants/curve/duration/lockout; duration RNG, defense formula and ordering Low | Binary fixtures for timing, RNG consumption, duration draw/extension and three-in-five aftermath |
