...
| AI | Objective/difficulty-aware computer players | Deterministic objective-aware planner with recovered reaction/attitude initialization and updates, all nine difficulty-band consumers, role/family assignment, action history, hiring and placement, complete family-3/5/10/12/13/14 handlers, family-1 continuations, and complete family-11 equipment/Heal/local-Attack/formation sequence. Six-by-81 formation sectors preserve inactive family records and are hashed/saved/replayed. Unrecovered handlers use the explicit provisional fallback planner. | Strategic-state, family-3/5/10/11/12/13/14, persistence, and resolution-band integration High; complete original planning policy Low | Add fixed original-runtime family traces and larger-player stress cases; recover remaining handlers |
