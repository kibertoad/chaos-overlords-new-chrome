...
| Music | Original CD-audio soundtrack, represented by eight GOG Ogg tracks (`Track02`-`Track09`) | Extracted only; no runtime music player yet | GOG pack, High format/source identity; original sequencing unknown | Implement streamed playback without an optical-disc dependency; recover track mapping, sequencing, transitions, repeat/advance, and preference/volume behavior |
