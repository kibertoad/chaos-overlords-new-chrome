...
| City/Sector UI | Original screen/panel workflow | Routed title/setup/handoff/city/sector/gang/finance/ranking/commands/hire/events/endgame flow starts authoritative recovered cities; the city composites each 54x52 sector from the neutral/six owner-colored original PX1000x layers; sector/hire/gang views slice the complete original site and gang portrait sheets; finance previews exact Upkeep cash flow without mutation; ranking uses authoritative timed scores or objective progress; Core-approved commands, Hire and notification mutations are replay-recorded | Static executable evidence High for generator and mapped atlas identities; interaction/coordinates Medium-Low | Complete UI atlas/setup detail, richer target workflow, remaining research/equipment panels, seed/context fixture and golden screens |
