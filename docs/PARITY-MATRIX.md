...
| AI | Objective/difficulty-aware computer players | Deterministic objective-aware planner with recovered reaction/attitude initialization and updates, all nine difficulty-band consumers, role/family assignment, action history, hiring and placement, complete family-2/3/5/7/9/10/12/13/14 handlers, family-1 continuations, and complete family-11 equipment/Heal/local-Attack/formation sequence. Six-by-81 polymorphic family-2/7 focus/family-11 formation values preserve inactive family records and are hashed/saved/replayed. Family 2 uses exact ten-scenario competition standings for mode-6 leader routing. Unrecovered handlers use the explicit provisional fallback planner. | Strategic-state, family-2/3/5/7/9/10/11/12/13/14, persistence, and resolution-band integration High; complete original planning policy Low | Add fixed original-runtime family traces and larger-player stress cases; recover remaining handlers |
