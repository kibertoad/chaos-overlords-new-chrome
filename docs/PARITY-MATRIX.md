...
| AI | Objective/difficulty-aware computer players | Deterministic objective-aware planner with recovered reaction/attitude initialization and updates, all nine difficulty-band consumers, role/family assignment, action history, hiring and placement, complete family-0/2/3/5/6/7/9/10/12/13/14 handlers, family-1 continuations, and complete family-11 equipment/Heal/local-Attack/formation sequence. Six-by-81 polymorphic family-2/7 focus/family-11 formation values and family-6 coverage sectors preserve inactive family records and are hashed/saved/replayed. Family 2 uses exact ten-scenario competition standings for mode-6 leader routing. Family 4 is the only unrecovered handler and uses the explicit provisional fallback planner. | Strategic-state, recovered-family, persistence, and resolution-band integration High; complete original planning policy Low | Add fixed original-runtime family traces and larger-player stress cases; recover family 4 |
