...
| Notifications | Bounded per-player ordered queues | Presentation-independent mechanical notification schema plus a Last Turn Events projection that retains the newest 16 report-worthy entries in recovered drop-oldest order | Static report-recorder table stride/count/copy/cursor path High; current kind filtering and delivery timing Medium-Low | Validate report-kind filtering and exact handoff/viewer cursor transitions |
