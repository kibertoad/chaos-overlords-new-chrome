...
| Hire pool | Three distinct offers; placement in Hire phase | Deferred purchase/placement, cost and capacity validation, deterministic vacancy refill, events and notifications implemented | Manual, High for lifecycle/caps; refill ordering Low | Binary offer-selection and refill fixtures; implement explicit snub |
...
| Objectives | Ten named scenarios and objective thresholds | Provisional live end-of-turn evaluation, Big Man center-sector point accrual, Eliminate cleanup, authoritative state projection, tied winners, events/notifications and outcome hashing | Manual pages 12–15, High for thresholds/weights/effects; timing and special edges Low | Siege mapping and binary boundary/tie/ordering fixtures |
| Timers | 26/52/104/208 turns | Implemented as model | Manual, High | End-turn boundary fixtures |
| Endgame | Ranking, five awards, statistics | Timed score standings with competition ties; all five award projections, Hide count, retaliation exclusion and outcome/event/hash integration implemented; objective ranking/UI absent | Manual pages 46–47 and scoring tables, High mappings; tie order/zero threshold Low | Recover objective ranking; binary tie/no-award fixtures; implement Endgame screen |
