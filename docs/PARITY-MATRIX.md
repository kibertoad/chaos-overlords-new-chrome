...
| Police | Combat 20, Detect 12, stealth detection curve; Control prohibited while present | Provisional phase-wide crackdown attacks, detection, damage, events, notifications, casualties, and submission/runtime Control lockout implemented | Manual, High for constants/curve/lockout; defense formula and ordering Low | Binary fixtures for timing, defense/damage formula, RNG consumption, 3–5-turn duration and aftermath |
