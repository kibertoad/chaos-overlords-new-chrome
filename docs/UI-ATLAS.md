...
| `PX00201` | Endgame award icons (fist, skull, chicken, dollar, safe), colored player-number rows, the opaque `96,112,160,64` statistics strip, and pressed Awards/Stats/Done controls | High from visible content, original Help Endgame topic, and native blit destinations |
