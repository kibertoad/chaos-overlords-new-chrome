...
loading, title/setup/city/endgame routing, keyboard and inverse-mapped mouse input,
...
- The client has a title/setup/city router and virtual-coordinate mouse input,
  plus a state-driven endgame summary on the mapped original frame, but still
