...
- [Latest playable work](#latest-playable-work)
  ...
  - [Turn resolution, commands, and economy](#turn-resolution-commands-and-economy)
  - [Combat, police, and Crackdowns](#combat-police-and-crackdowns)
  - [Objectives, ranking, and endgame](#objectives-ranking-and-endgame)
  - [Computer players and headless tournaments](#computer-players-and-headless-tournaments)
  - [City, sector, and console presentation](#city-sector-and-console-presentation)
  - [Management panels](#management-panels)
  - [Turn reports and hot-seat handoff](#turn-reports-and-hot-seat-handoff)
  - [Input, Options, and panel motion](#input-options-and-panel-motion)
  - [Help, audio, and video](#help-audio-and-video)
  - [Saves, replays, and canonical hashing](#saves-replays-and-canonical-hashing)
...
- Online AI takeover is player-approved end to end. A departure or wholly missed timed turn opens
  ...
  `match.playerTakenOver` and `match.playerReturned` record controller transfers at a clean Command boundary.
...
### New-game setup, local players, and startup randomness
...
### Turn resolution, commands, and economy
...
### Objectives, ranking, and endgame
...
### Computer players and headless tournaments
...
### City, sector, and console presentation
...
### Turn reports and hot-seat handoff
...
### Input, Options, and panel motion
...
### Extraction, asset verification, and diagnostics
