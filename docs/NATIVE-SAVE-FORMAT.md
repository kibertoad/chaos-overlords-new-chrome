...
Status: implemented format version 15
...
- UTF-8 JSON with camel-case property names and `formatVersion: 15`.
...
| Member | Contents |
|---|---|
| `formatVersion` | Schema discriminator; currently `15` |
...
Readers currently accept versions 1 through 15. This pre-1.0 compatibility is
...
embeds native version 13, version 15 embeds native version 14, and version 16
embeds native version 15.
...
canonical state hash is version 18. Initial-state migration is covered for
