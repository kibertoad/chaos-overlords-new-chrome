...
- The current implementation baseline includes the recovered sector Combat +
  ...
  dispatch, exact isolated hire-offer ranking and 393 passing tests. Native saves remain
...
Current automated baseline: the solution builds successfully, 393 tests
