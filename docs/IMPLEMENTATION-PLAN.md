...
| M3 | Foundation started | Ordered base Upkeep economy; non-mutating original City/Sector Financial projection for pending contracts, upkeep, queued cash actions, income and Chaos; all Instant and Transaction actions; Move/Terminate; grouped Influence and Control; phase-opening effective-stat snapshots for simultaneous Instant rolls; per-turn Chaos; Crackdown lifecycle; influenced-site stats; Research caps; Factory discount with same-turn acquisition/replacement coverage; recovered 0/1/2 difficulty pools and thresholds for Heal, Influence, Research, Chaos, plus high-band owned-sector Crackdown reduction | Binary police/call-order fixtures, Control conflict edges, remaining special buildings, original Factory locality/rounding evidence, and M2 gate |
...
Current automated baseline: the solution builds successfully, 1125 tests
