...
- Retain the implemented bounded structured session logs and local crash
  reports; add an explicit privacy-respecting diagnostics export action.
...
6. Implement non-interactive polish that has objective specifications: remaining
   ...
   benchmarks, and automated installer/package checks. Retain the deterministic
   Smacker playback and failure fixtures while native capture remains deferred.
