...
- The current implementation baseline includes the recovered sector Combat +
  ...
  passes 1,327 tests. Native saves are v19, replay is v21, and the canonical
  hash is v22.
...
Current automated baseline: the solution builds successfully, 1327 tests
