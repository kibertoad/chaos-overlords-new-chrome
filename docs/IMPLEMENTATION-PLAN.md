...
| Tests | 520 tests covering parsers/provenance, extraction, scenarios, deterministic command and phase resolution, difficulty bands, AI strategic/planning state, family dispatch, hire schedules/ranking/equipment, combat, saves, replays, installers, and repository policy | Original-reference fixtures, checked-in save migrations, visual tests, larger-player AI stress, and native interactive installer/play tests |
...
- The current implementation baseline includes the recovered sector Combat +
  ...
  dispatch, exact isolated hire-offer ranking/rejection and 520 passing tests. Native saves are
...
Current automated baseline: the solution builds successfully, 520 tests
