...
| M5 | Foundation started | Scenario predicates, timed scores/standings with ties, live end-of-turn evaluation, state-derived winners, all five award projections, outcome events/notifications and hashing | Big Man accrual, Eliminate/Siege special behavior, objective ranking/tie fixtures, persistence, UI deliverable and M4 gate |
...
Current automated baseline: the solution builds successfully, 215 tests
