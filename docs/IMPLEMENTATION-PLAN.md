...
- The current implementation baseline includes the recovered sector Combat +
  ...
  12-16 sector-selection kernels, live recovered hire-placement rules, and 972
...
Current automated baseline: the solution builds successfully, 972 tests
