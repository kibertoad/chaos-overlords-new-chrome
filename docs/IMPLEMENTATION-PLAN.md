...
- The current implementation baseline includes the recovered sector Combat +
  ...
  12-16 sector-selection kernels, live recovered hire-placement rules, and 1,045
...
Current automated baseline: the solution builds successfully, 1045 tests
...
general-effect slots load with proven setup selection/rejection, panel,
