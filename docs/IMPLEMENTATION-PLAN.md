...
- The current implementation baseline includes the recovered sector Combat +
  ...
  dispatch, exact isolated hire-offer ranking/rejection and 519 passing tests. Native saves are
...
Current automated baseline: the solution builds successfully, 519 tests
