...
planning timer. Legacy color depth is explicitly always on. The timer uses its
original setup controls, main-panel bar, expiry path, and warning slots 7/8.
Remaining trigger and animation work, exact Options defaults/cadence and preference/menu
...
6. Complete setup alignment, remaining management hit maps, atlas semantics,
   ...
   sound triggers, exact Options defaults and original music preference
