...
| M3 | Foundation started | Ordered base Upkeep economy; all six Instant actions resolved; grouped Influence resistance/ownership/Support; deterministic Research progress/completion; pure police helpers | Cross-player influence conflicts, full site benefits, desertion/modifiers, research tech/site caps, equipment deliverable and M2 gate |
...
Current automated baseline: the solution builds successfully, 138 tests
