...
| M1 | Foundation started | Ten scenario definitions and durations; recovered one-to-six local-human setup with bounded names/portraits, face-drag color move/exchange, and ascending sparse-slot Computer completion with unique portrait/name RNG; 32x32 density-derived 8x8 city, balanced three-site rejection sampling, explicit sector income/tolerance, fixed-candidate HQ permutation, Right Hands Force 10, Armageddon exclusions/overrides, exact `SMGFUNDAGE` and `SMGISLANDS`; title/setup/city router with scenario/duration/local-player controls, original overlord portrait selection, global AI Mentality panel, manual-backed `PX05021` Game Info panel with multiplayer/load auto-open, virtual-coordinate mouse input, and mapped PX00130/PX00143/PX00128 frames | Original seed/setup fixture; remaining setup atlas/hit maps and golden screens |
...
Current automated baseline: the solution builds successfully, 1154 tests
