...
| Client | Scaled 640x460 title/setup/handoff/city/events/endgame router backed by authoritative `MatchState`; recovered setup; local setup controls; private ready handoff; replay-recorded notification dismissal; virtual-coordinate mouse plus keyboard interaction; saves and replays | Full setup detail, sprites/atlas, remaining management panels and hit maps, AI driver, animation, sound/music, accessibility |
