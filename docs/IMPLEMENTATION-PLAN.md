...
| M3 | Foundation started | Ordered base Upkeep economy; manual-backed constants and phase-integrated Bribe/Snitch resolvers with events/notifications; deterministic Research progress/completion resolver; pure police helpers | Desertion/modifiers plus research tech/site caps, remaining site/equipment deliverable and M2 gate |
...
Current automated baseline: the solution builds successfully, 130 tests
