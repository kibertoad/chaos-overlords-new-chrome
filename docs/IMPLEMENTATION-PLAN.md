...
- The current implementation baseline includes the recovered sector Combat +
  ...
  dispatch, exact hire-offer ranking/rejection and 558 passing tests. Native saves are
  v9, replay is v10, and the canonical hash is v12.
...
Current automated baseline: the solution builds successfully, 558 tests
