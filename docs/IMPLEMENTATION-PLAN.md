...
- The current implementation baseline includes the recovered sector Combat +
  ...
  passes 1,376 tests. Native saves are v22, replay is v24, and the canonical
  hash is v25.
...
- Executable-derived Upkeep and both Finance scopes preserve the flat $1 sector
  tax plus influenced-site Cash that the original stores in one recomputed byte.
...
Current automated baseline: the solution builds successfully, 1376 tests
