...
| Client | Scaled 640x460 title/setup/handoff/city/commands/hire/events/endgame router backed by authoritative `MatchState`; recovered setup; local setup controls; private ready handoff; Core-derived commands; three-offer hire/snub panel; replay-recorded mutations; mouse/keyboard, saves and replays | Full setup detail, richer target workflow, sprites/atlas, remaining management panels/hit maps, AI driver, animation, sound/music, accessibility |
