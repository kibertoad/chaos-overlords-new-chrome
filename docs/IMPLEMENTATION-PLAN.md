...
- The current implementation baseline includes the recovered sector Combat +
  ...
  passes 1,426 tests. Native saves are v22, replay is v24, and the canonical
  hash is v25.
