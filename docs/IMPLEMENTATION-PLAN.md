...
- Recreate Options for color depth, music, sound effects, base statistics,
  ...
  music/effects volume and the idle-gang warning are implemented; the remaining
  settings still require reconstruction.
...
Current automated baseline: the solution builds successfully, 996 tests
...
both recreation-native preferences. Remaining trigger
