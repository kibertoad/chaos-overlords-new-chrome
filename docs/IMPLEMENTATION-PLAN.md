...
- Maintain the F1 Help route and cross-platform in-game viewer backed by the
  ...
  and restore inline topic links and rich formatting.
...
Current automated baseline: the solution builds successfully, 1266 tests
