...
- The current implementation baseline includes the recovered sector Combat +
  ...
  passes 1,368 tests. Native saves are v22, replay is v24, and the canonical
  hash is v25.
...
Current automated baseline: the solution builds successfully, 1368 tests
