...
| Tests | 613 tests covering parsers/provenance, extraction, scenarios, deterministic command and phase resolution, difficulty bands, AI strategic/planning state, family dispatch, sector selection and hire placement, hire schedules/limits/ranking/equipment, combat, saves, replays, installers, and repository policy | Original-reference fixtures, checked-in save migrations, visual tests, larger-player AI stress, and native interactive installer/play tests |
...
- The current implementation baseline includes the recovered sector Combat +
  ...
  selection and hire-placement kernels, and 613 passing tests. Native saves are
  v11, replay is v12, and the canonical hash is v14.
...
Current automated baseline: the solution builds successfully, 613 tests
