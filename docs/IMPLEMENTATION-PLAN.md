...
- The current implementation baseline includes the recovered sector Combat +
  ...
  12-16 sector-selection kernels, live recovered hire-placement rules, and 1,071
...
Current automated baseline: the solution builds successfully, 1071 tests
