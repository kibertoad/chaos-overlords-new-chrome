...
Panel entrances use the recovered vertical 344-pixel primary travel and
quarter-second benchmark target. Remaining trigger and animation work, Options
close/alternate-panel/combat cadence and preference/menu
...
6. Complete setup alignment, remaining management hit maps, atlas semantics,
   ...
   sound triggers, Options close/alternate-panel/combat cadence and original music preference
