...
Current automated baseline: the solution builds successfully, 1122 tests
...
planning timer. The presentation toggles use the recovered Current-statistics,
