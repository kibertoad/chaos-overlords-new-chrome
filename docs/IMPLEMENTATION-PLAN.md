...
| Extraction | Transactional/versioned exact-inventory and full-pack SHA-256 validation with stale-output replacement and schema-v1 machine-readable diagnostic reports; 215 repaired RGB555 PX16 images, 214 retained plus decoded PX08 resources, 28 WAVs, 8 Ogg tracks, 2 structurally validated Smacker-v2 videos with exact timing/audio metadata, bounded legacy WinHelp text/topic/context/font/hotspot decoding, help and opaque files; generated 686-output factual catalog | Transparency/color-key validation, managed Smacker frame/audio decompression, exact WinHelp typography/paragraph geometry, semantic role/owner resolution |
