...
- The current implementation baseline includes the recovered sector Combat +
  ...
  passes 1,154 tests. Native saves are v19, replay is v20, and the canonical
  hash is v22.
...
Current automated baseline: the solution builds successfully, 1325 tests
