...
| M3 | Foundation started | Ordered base Upkeep economy; manual-backed constants and phase-integrated Bribe/Snitch resolvers with events/notifications; pure police helpers | Desertion/modifiers plus remaining site/research/equipment deliverable and M2 gate |
...
Current automated baseline: the solution builds successfully, 125 tests
