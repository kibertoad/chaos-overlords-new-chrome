...
- The current implementation baseline includes the recovered sector Combat +
  ...
  dispatch, exact hire-offer ranking/rejection and 556 passing tests. Native saves are
...
Current automated baseline: the solution builds successfully, 556 tests
