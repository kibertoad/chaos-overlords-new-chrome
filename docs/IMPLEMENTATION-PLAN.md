...
- The current implementation baseline includes the recovered sector Combat +
  ...
  12-16 sector-selection kernels, live recovered hire-placement rules, and 1,030
...
- Static kernels guard family-1's cash 50/51, Force 8/9, effective-Heal -3/-4,
  ...
  decisions for the remaining selector contexts, then follow with larger-player
  and objective-completion AI stress traces.
...
Current automated baseline: the solution builds successfully, 1030 tests
