...
| Client | Scaled 640x460 title/setup/city/endgame router backed by authoritative `MatchState`; recovered city/HQ/Right Hands setup; scenario/duration/local-player controls; virtual-coordinate mouse plus keyboard interaction; native saves/autosave and replays | Full setup detail, sprites/atlas, original management panels and hit maps, AI driver, animation, sound/music, accessibility |
