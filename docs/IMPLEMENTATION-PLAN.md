...
| Tests | 372 tests covering parsers/provenance, extraction, scenarios, deterministic command and phase resolution, difficulty bands, AI strategic state/equipment, combat, saves, replays, installers, and repository policy | Original-reference fixtures, checked-in save migrations, visual tests, larger-player AI stress, and native interactive installer/play tests |
...
- The current implementation baseline includes the recovered sector Combat +
  Defense advantage hostility pass and 372 passing tests. Native saves remain
...
Current automated baseline: the solution builds successfully, 372 tests
