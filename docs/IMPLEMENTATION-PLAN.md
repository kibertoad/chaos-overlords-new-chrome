...
- The current implementation baseline includes the recovered sector Combat +
  ...
  dispatch, exact hire-offer ranking/rejection and 543 passing tests. Native saves are
  v8, replay is v9, and the canonical hash is v11.
...
Current automated baseline: the solution builds successfully, 543 tests
