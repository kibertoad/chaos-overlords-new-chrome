...
Current automated baseline: the solution builds successfully, 1499 tests
...
only the displayed record through save v23, replay v25, and canonical hash v26;
