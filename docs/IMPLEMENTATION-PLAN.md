...
| Extraction | Transactional/versioned exact-inventory and full-pack SHA-256 validation with stale-output replacement and schema-v1 machine-readable diagnostic reports; 215 repaired RGB555 PX16 images, 214 retained plus decoded PX08 resources, 28 WAVs, 8 Ogg tracks, 2 Smacker videos, bounded legacy WinHelp text/topic/context/font/hotspot decoding, help and opaque files; generated 686-output factual catalog | Transparency/color-key validation, video strategy, exact WinHelp typography/paragraph geometry, semantic role/owner resolution |
...
- The current implementation baseline includes the recovered sector Combat +
  ...
  passes 1,421 tests. Native saves are v22, replay is v24, and the canonical
  hash is v25.
