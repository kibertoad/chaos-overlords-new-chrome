...
- The current implementation baseline includes the recovered sector Combat +
  ...
  12-15 sector-selection kernels, live recovered hire-placement rules, and 702 passing tests. Native saves are
...
Current automated baseline: the solution builds successfully, 702 tests
