...
| Simulation | Deterministic city seed, six players, stable gang IDs, typed command queue, headless phase coordinator, Upkeep, all 14 command resolvers, binary player/roster-slot Instant, Combat/police, Transaction, Chaos, and Movement scans with deferred gifts and Sell payout overwrite, simultaneous gang/Crackdown combat with exact police visible/Hide detection and Force 5 + Combat 20 attack pools, exact one-off/recurring Hide lifecycle, additive 3–5-turn police duration and exact inclusive-five-turn two-slot control-loss history, hidden attack/visibility checks, and local influenced-site stats | Crackdown notification/timing fixtures, transaction runtime corroboration, original RNG seeding/order and exact parity formulas |
...
- The current implementation baseline includes the recovered sector Combat +
  ...
  passes 1,370 tests. Native saves are v22, replay is v24, and the canonical
  hash is v25.
...
Current automated baseline: the solution builds successfully, 1370 tests
