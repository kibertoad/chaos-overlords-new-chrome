...
- The current implementation baseline includes the recovered sector Combat +
  ...
  passes 1,353 tests. Native saves are v21, replay is v23, and the canonical
  hash is v24.
...
Current automated baseline: the solution builds successfully, 1353 tests
