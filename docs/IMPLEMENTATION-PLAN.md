...
| M4 | Foundation started | Recovered raw RNG/range algorithms; serializable state; effective item/site stats; phase-wide Attack/retaliation and police snapshots; recovered exact police visible/Hide detection and Force 5 + Combat 20 attack pools; recovered difficulty-specific d20 hidden detection, band-0 Defense reduction, 6+/5+/4+ main rolls with quarter-pool damage floor, exact Hide/weapon/Martial-Arts retaliation eligibility, 5+/5+/4+ halved retaliation, elimination and recorded rolls; Simple/Detailed twin-resolution hash equivalence plus cancellation and large-elapsed no-hang coverage; opening, retaliation, unarmed, evasion and detected-police animation/audio routing | Resolve reveal timing, investigate the reported GOG/1.1 Detailed Combat freeze, complete reference combat/Crackdown notification fixtures, validate animation cadence/color keys, and M2-M3 gates |
...
Current automated baseline: the solution builds successfully, 1305 tests
