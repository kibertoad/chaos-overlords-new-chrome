...
- The current implementation baseline includes the recovered sector Combat +
  ...
  selection kernels, live recovered hire-placement rules, and 676 passing tests. Native saves are
...
Current automated baseline: the solution builds successfully, 676 tests
