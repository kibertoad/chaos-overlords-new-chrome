...
| Client | Scaled 640x460 title/setup/handoff/city/endgame router backed by authoritative `MatchState`; recovered setup; scenario/duration/local-player controls; private ready handoff; virtual-coordinate mouse plus keyboard interaction; native saves/autosave and replays | Full setup detail, sprites/atlas, original management panels and hit maps, AI driver, animation, sound/music, accessibility |
