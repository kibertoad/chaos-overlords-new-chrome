...
| [Help fidelity](https://github.com/kibertoad/chaos-overlords-new-chrome/issues/140) | Help content and navigation are functional. The imported document retains the original font descriptors and paragraph records; the viewer follows source indents, centering, and paragraph spacing on its pixel-font grid. Native typography and exact geometry still need comparison with original captures. Unsafe legacy macro/external-file execution remains disabled. |
