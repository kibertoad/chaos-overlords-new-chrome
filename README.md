...
| Computer players | Deterministic objective-aware AI with recovered mentality, attitudes, reactions, hiring, placement, difficulty calibration, and several original strategy-family decision sequences wired into gameplay. | The complete original planning policy is not recovered yet; unrecovered families and branches still use a provisional deterministic planner. |
