...
| Saves and replays | F5/F9 recreation-native save/load, end-turn autosaves, F6/F10 deterministic record/playback verification, bounded loading, read-back-before-promotion, and last-valid-generation backup recovery for both saves and replays. Current formats are save v21, replay v23, and canonical hash v24; event bodies, nested resolution facts, and phase-boundary history are authenticated. | These formats may change incompatibly before 1.0.0. Original 1996 save import/export is not supported. |
