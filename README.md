...
| Audio, music, and video | Original audio, eight music tracks, and two videos are extracted; equipped-weapon attacks play their mapped original sound cues, and available music tracks stream sequentially in CD order. | Exact original music selection, transitions, preferences, and volume behavior still need recovery and native-platform validation. Video playback and most UI/police/impact sound triggers are not wired yet. |
