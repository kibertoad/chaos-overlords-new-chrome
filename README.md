...
| Game setup | All ten scenarios, four durations, the global AI Mentality setting, original portraits, one-to-six configured local human players, and the recovered optional 30-second/2-minute/5-minute planning timer. Omitted slots become computer players, so every match has six participants. | Some setup-screen alignment and original hit regions still need parity work. |
...
| City and sector UI | Native 640x460 presentation with integer-friendly scaling, persistent windowed/borderless-fullscreen display, ownership-composited city art, selectable 8x8 city, detailed 3x3 sector view, gang/site information, finance, ranking, research, equipment, hire, combat summary, search, events, endgame, and a modern viewer for the locally imported original help. Keyboard and mouse navigation are supported, including right-click cancellation of transient interactions and nested panels. Options can show base or current gang statistics and enable or disable bounded panel motion. | Remaining original hit maps, configurable bindings, rich help formatting/links, and golden-screen alignment are unfinished. |
...
| Windowed/fullscreen display | F11 | Use F11 from any screen; the borderless-fullscreen choice is remembered between launches |
