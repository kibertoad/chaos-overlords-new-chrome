...
/**
 * The match event log in the Postgres dialect: the gapless, self-allocating sequence every stream
 ...
 */
export function postgresEventRepository(db: PostgresDatabase): EventRepository {
