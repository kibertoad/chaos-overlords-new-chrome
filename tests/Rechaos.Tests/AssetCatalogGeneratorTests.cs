    ...
    public void CatalogContainsEveryManifestEntryInStableOrder()
    {
        var manifest = new AssetManifest(
            ...
            [
                ...
                new ExtractedAsset("raw/px08/PX00131", 10, new string('7', 64),
                    "DATA/PX08/PX00131", "application/x-chaos-px08", new AssetConversion("copy")),
        ...
        Assert.Contains("Asset count: 7", catalog);
        ...
        Assert.Contains("Dormant limited/demo promotion", catalog);
        Assert.Contains("No caller in supported executable; deliberately unrouted", catalog);
