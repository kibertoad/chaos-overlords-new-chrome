...
evidence: [FND-DATA-003, FND-ASSET-001, FND-RESEARCH-002, FND-GANG-001, FND-EQUIP-001, FND-EQUIP-002, FND-AUDIO-002, FND-AUDIO-013, SRC-RECHAOS-3561D41]
conflicting: []
split_with: []
related: []
---
...
| `0x7A` | 2 | `INT16LE` | `type` | The item's category, one of the values below. | sourced | FND-DATA-003, SRC-RECHAOS-3561D41 |
...
| `0x82` | 2 | `INT16LE` | `combat` | Modifier to the Combat of the gang that carries the item. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x84` | 2 | `INT16LE` | `defense` | Modifier to Defense, applied the same way as `combat`. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x86` | 2 | `INT16LE` | `stealth` | Modifier to Stealth, applied the same way as `combat`. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x88` | 2 | `INT16LE` | `detect` | Modifier to Detect, applied the same way as `combat`. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x8A` | 2 | `INT16LE` | `chaos` | Modifier to Chaos, applied the same way as `combat`. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x8C` | 2 | `INT16LE` | `control` | Modifier to Control, applied the same way as `combat`. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x8E` | 2 | `INT16LE` | `heal` | Modifier to Heal, applied the same way as `combat`. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x90` | 2 | `INT16LE` | `influence` | Modifier to Influence, applied the same way as `combat`. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x92` | 2 | `INT16LE` | `research` | Modifier to Research, applied the same way as `combat`. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x94` | 2 | `INT16LE` | `strength` | Modifier to Strength, applied the same way as `combat`. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x96` | 2 | `INT16LE` | `blade` | Modifier to Blade, applied the same way as `combat`. 0 in every record. | sourced | FND-DATA-003, FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x98` | 2 | `INT16LE` | `range` | Modifier to Range, applied the same way as `combat`. | sourced | FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x9A` | 2 | `INT16LE` | `fighting` | Modifier to Fighting, applied the same way as `combat`. 0 in every record. | sourced | FND-DATA-003, FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x9C` | 2 | `INT16LE` | `martial_arts` | Modifier to Martial Arts, applied the same way as `combat`. 0 in every record. | sourced | FND-DATA-003, FND-GANG-001, SRC-RECHAOS-3561D41 |
| `0x9E` | 2 | `INT16LE` | `attack_animation` | Number of the attacker's animation strip, `PX07000` plus this value in `DATA/PX16/` or `DATA/PX08/`, 0 to 26. | sourced | FND-DATA-003, SRC-RECHAOS-3561D41 |
| `0xA0` | 2 | `INT16LE` | `hit_animation` | Number of the target's animation strip, `PX07100` plus this value in `DATA/PX16/` or `DATA/PX08/`, 0 to 19. | sourced | FND-DATA-003, SRC-RECHAOS-3561D41 |
| `0xA2` | 2 | `INT16LE` | `sound` | Attack sound: an attack with the item loads `DATA/SND00500` plus this value, 0 to 17. | sourced | FND-DATA-003, FND-AUDIO-013, SRC-RECHAOS-3561D41 |
...
|---|---|---|---|---|
| 0 | `ITEM_TYPE_MELEE` | A melee weapon. | sourced | FND-DATA-003, SRC-RECHAOS-3561D41 |
| 1 | `ITEM_TYPE_BLADE` | A bladed weapon. | sourced | FND-DATA-003, SRC-RECHAOS-3561D41 |
| 2 | `ITEM_TYPE_RANGED` | A ranged weapon. | sourced | FND-DATA-003, SRC-RECHAOS-3561D41 |
