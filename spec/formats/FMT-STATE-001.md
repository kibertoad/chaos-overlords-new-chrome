...
evidence: [FND-AI-004, FND-AI-007, FND-COMBAT-001, FND-COMBAT-004, FND-CHAOS-001, FND-CONTROL-001, FND-DETECT-001, FND-EQUIP-002, FND-EQUIP-007, FND-GANG-001, FND-GANG-003, FND-HIDE-001, FND-HIRE-002, FND-MOVE-001, FND-PLATFORM-003, FND-STATE-002, FND-TURN-001, FND-TURN-002, FND-TURN-004, FND-TURN-005, FND-UI-036, SRC-RECHAOS-3561D41]
conflicting: []
split_with: []
related: []
---
...
| `0x03` | 1 | `INT8` | `force` | Current Force: 10 for the Right Hands, set when hired, lowered by combat damage; the gang dies when it falls below 1 | supported | FND-STATE-002 |
...
| `0x12` | 1 | `INT8` | `combat` | Effective Combat, including the combat skills that fit the weapon (see below) | supported | FND-AI-004, FND-GANG-001, FND-STATE-002 |
