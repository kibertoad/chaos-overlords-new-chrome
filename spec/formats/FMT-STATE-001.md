...
evidence: [FND-AI-004, FND-AI-007, FND-COMBAT-001, FND-COMBAT-004, FND-CHAOS-001, FND-CONTROL-001, FND-DETECT-001, FND-EQUIP-002, FND-GANG-001, FND-GANG-003, FND-HIDE-001, FND-HIRE-002, FND-MOVE-001, FND-PLATFORM-003, FND-TURN-001, FND-TURN-002, FND-TURN-004, FND-TURN-005, FND-UI-036, SRC-RECHAOS-3561D41]
conflicting: []
split_with: []
related: []
---
...
|---|---|---|---|---|---|---|
| `0x00` | 1 | `INT8` | `player` | The owning player slot, 0 to 5 | sourced | SRC-RECHAOS-3561D41 |
| `0x01` | 1 | `UINT8` | `definition` | The gang's record number in the gang definition table read from `DATA/Gangs` | sourced | SRC-RECHAOS-3561D41 |
...
| `0x03` | 1 | `INT8` | `force` | Current Force | sourced | SRC-RECHAOS-3561D41 |
...
| `0x08` | 1 | `INT8` | `target` | First target byte of `action`. The Attack picker writes it with `target_2` | supported | FND-COMBAT-004, FND-TURN-002 |
| `0x09` | 1 | `INT8` | `target_2` | Second target byte of `action`. The Attack picker writes it with `target` | supported | FND-COMBAT-004 |
...
| `0x12` | 1 | `INT8` | `combat` | Effective Combat | supported | FND-AI-004, FND-GANG-001 |
...
| `0x16` | 1 | `INT8` | `chaos` | Effective Chaos | sourced | SRC-RECHAOS-3561D41 |
...
| `0x19` | 1 | `INT8` | `influence` | Effective Influence | sourced | SRC-RECHAOS-3561D41 |
| `0x1A` | 1 | `INT8` | `research` | Effective Research | sourced | SRC-RECHAOS-3561D41 |
| `0x1B` | 1 | `INT8` | `strength` | Effective Strength | sourced | SRC-RECHAOS-3561D41 |
| `0x1C` | 1 | `INT8` | `blade` | Effective Blade | sourced | SRC-RECHAOS-3561D41 |
| `0x1D` | 1 | `INT8` | `ranged` | Effective Ranged | sourced | SRC-RECHAOS-3561D41 |
| `0x1E` | 1 | `INT8` | `fighting` | Effective Fighting | sourced | SRC-RECHAOS-3561D41 |
...
bonus when the gang's player owns the gang's sector [FND-GANG-001].
...
- `player`, `definition` and `force` are placed from SRC-RECHAOS-3561D41 only,
  which describes another executable. No finding yet gives their offsets in this
  build.
- Which statistic each of `chaos`, `influence`, `research`, `strength`,
  `blade`, `ranged` and `fighting` holds comes from SRC-RECHAOS-3561D41 only.
  The findings show fourteen effective statistics ending at `0x1F`, and place
  Combat, Defense, Stealth, Detect, Control, Heal and Martial Arts.
- What `target` and `target_2` hold for each action (the target player and
  roster slot for Attack, the destination sector for Move, the item for Equip,
  the site slot for Influence, the recipient for Give, the selection mask for
  Sell) is not pinned by the findings.
- The byte the Equip picker writes as the queued item has no offset in the
  findings.
