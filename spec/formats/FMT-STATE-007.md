...
evidence: [FND-AI-019, FND-AI-021, FND-SAVE-001, FND-STATE-006]
conflicting: []
split_with: []
related: []
---
...
[FND-AI-019]. The reset of a record stores 99 in `family`, 0 in `unk_01`, 0
...
| `0x01` | 1 | `UINT8` | `unk_01` | A flag: set to 1 for a slot whose gang is not alive, on a player's first plan for slot 0, and by several family handlers; cleared by the reset. Read only by selector `0x48` | supported | FND-STATE-006 |
...
| `0x0B` | 1 | `UINT8` | `unk_0B` | Padding: no instruction addresses it | supported | FND-STATE-006 |
...
- What `unk_01` means to the planner.
