...
| `0x45C4` | 24 | `INT32LE[6]` | `cursor_sectors` | Block 3, a copy of `0x004ABBF0`. Per player, the selected sector, restored when the player plans again; a new game starts it on the sector of the player's first gang. | supported | FND-SAVE-001, FND-SAVE-003 |
| `0x45DC` | 6 | `UINT8[6]` | `portraits` | Block 4, a copy of `0x004A5F00`. Per player, the portrait number, chosen on the setup screens. | supported | FND-SAVE-001, FND-SAVE-003 |
...
| `0x4602` | 4 | `INT32LE` | `turn_limit` | Block 8, a copy of `0x004A5EF8`. The glossary's `turn_limit`. | supported | FND-SAVE-001, FND-OBJECTIVE-003 |
...
| `0x47C2` | 6 | `UINT8[6]` | `player_active` | Block 13, a copy of `0x004ABBE0`. The glossary's `player_active`: per player, whether the player is still in the match. | supported | FND-SAVE-001, FND-OBJECTIVE-003 |
...
| `0xAF40` | 2 | `INT16LE` | `city_map_image` | Block 27, a copy of `0x00494830`. The city map is image `PX10000` plus this value; it is 0 in every match. The source calls it the current player, and FND-STATE-007 repeats that label for `0x00494830`; the readers and writers FND-SAVE-003 lists do not bear it out. | supported | FND-SAVE-001, FND-SAVE-003 |
...
| `0xAFEA` | 24 | `INT32LE[6]` | `casualties` | Block 33, a copy of `0x004AB620`. Per player, the combat deaths of the player's gangs. | supported | FND-SAVE-001, FND-GANG-005 |
...
| `0xB0E0` | 6 | `UINT8[6]` | `players_human` | Block 39, a copy of `0x004ABC58`. Per player, 1 when a human at this computer plays the slot, else 0. | supported | FND-SAVE-001, FND-SAVE-003 |
| `0xB0E6` | 1 | `UINT8` | `preference_1` | Block 40. The Mentality preference byte, from `0x00487850`. Copied to the live preferences only after the closing marker matches. | supported | FND-SAVE-001, FND-SAVE-003 |
| `0xB0E7` | 1 | `UINT8` | `preference_2` | Block 41. The time limit preference byte, from `0x00487854`. | supported | FND-SAVE-001, FND-SAVE-003 |
| `0xB0E8` | 1 | `UINT8` | `preference_3` | Block 42. The objective preference byte, from `0x00487858`. | supported | FND-SAVE-001, FND-SAVE-003 |
...
- A load that fails on the closing marker has already copied every block
  into the live globals (FND-SAVE-002).
