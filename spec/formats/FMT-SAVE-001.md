...
| `0xAF40` | 2 | `INT16LE` | `city_map_image` | Block 27, a copy of `0x00494830`. The city map is image `PX10000` plus this value; it is 0 in every match. The source calls it the current player, which the code does not bear out. | supported | FND-SAVE-001, FND-SAVE-003 |
