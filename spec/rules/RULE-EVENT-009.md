...
No return value. Records one type-6 report for `player`. The cash failures share type 6 and tell Bribe, Equip and Hire apart by an argument of 1, 2 or 4; this one passes 4.
...
- Which of the report's three arguments holds the 4 is not recorded, so the procedure leaves it out.
